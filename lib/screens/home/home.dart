...
import 'package:instax/resources/databases/product_databases.dart';
import 'package:instax/resources/models/product_model.dart';
import 'package:instax/screens/home/item_detail.dart';
...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot<ProductModel>>(
        stream: ProductDatabases().streamVisit(),
        builder: (context, snapshot) {
          if (!snapshot.hasData) {
            ...
            return ChangeNotifierProvider(
              create: (_) => SearchProvider(snapshot.data!.docs),
              child: Scaffold(
                appBar: AppBar(
                  ...
                  children: [
                    ...
                    Consumer<SearchProvider>(
                      builder: (context, searchProvider, child) {
                        List<DocumentSnapshot<ProductModel>> listData =
                          ...
                          itemBuilder: (_, index) {
                            return Container(
                              ...
                              child: _buildItemList(
                                context: context,
                                productModel: listData[index].data()!,
                              ),
                            );
                          },
                        );
